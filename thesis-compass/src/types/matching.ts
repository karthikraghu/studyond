/**
 * Matching Types — Topics, Supervisors, Experts, and related entities.
 *
 * These types mirror the existing Studyond mock data schema (references/mock-data/types.ts)
 * and extend it with Thesis Compass-specific fields like match scores.
 */

// -- Enums matching existing Studyond data model --
